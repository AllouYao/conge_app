 ...
 */
final class Version20240102113241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_45E9C6715D430949 ON departure');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_45E9C6715D430949 ON departure (personal_id)');
    }
}
