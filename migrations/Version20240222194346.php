 ...
 */
final class Version20240222194346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail_retenue_forfetaire (id INT AUTO_INCREMENT NOT NULL, retenu_forfetaire_id INT NOT NULL, salary_id INT NOT NULL, personal_id INT NOT NULL, user_id INT DEFAULT NULL, amount NUMERIC(20, 2) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_21636309E38ABA12 (retenu_forfetaire_id), INDEX IDX_21636309B0FDF16E (salary_id), INDEX IDX_216363095D430949 (personal_id), INDEX IDX_21636309A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
