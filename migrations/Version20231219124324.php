 ...
 */
final class Version20231219124324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_charge (id INT AUTO_INCREMENT NOT NULL, codification VARCHAR(255) NOT NULL, intitule VARCHAR(255) NOT NULL, value NUMERIC(10, 2) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE charge_personals (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, amount_its NUMERIC(20, 2) DEFAULT NULL, amount_cnps NUMERIC(20, 2) DEFAULT NULL, amount_cmu NUMERIC(20, 2) DEFAULT NULL, amount_total_charge_personal NUMERIC(20, 2) DEFAULT NULL, num_part NUMERIC(10, 2) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_988A281D5D430949 (personal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE conge (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, date_depart DATE NOT NULL, date_retour DATE NOT NULL, date_dernier_retour DATE DEFAULT NULL, salaire_moyen NUMERIC(20, 2) DEFAULT NULL, allocation_conge NUMERIC(20, 2) DEFAULT NULL, commentaires VARCHAR(255) DEFAULT NULL, is_conge TINYINT(1) NOT NULL, type_conge VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_2ED893485D430949 (personal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contract (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, date_embauche DATE NOT NULL, date_effet DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, temps_contractuel VARCHAR(255) DEFAULT NULL, type_contrat VARCHAR(255) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_E98F28595D430949 (personal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE heure_sup (id INT AUTO_INCREMENT NOT NULL, personal_id INT DEFAULT NULL, started_hour DATETIME NOT NULL, ended_hour DATETIME NOT NULL, type_day VARCHAR(255) NOT NULL, type_jour_or_nuit VARCHAR(255) NOT NULL, started_date DATETIME NOT NULL, ended_date DATETIME NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_F74507C45D430949 (personal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE payroll (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, campagne_id INT NOT NULL, number_part NUMERIC(10, 2) DEFAULT NULL, base_amount NUMERIC(20, 2) DEFAULT NULL, sursalaire NUMERIC(20, 2) DEFAULT NULL, brut_amount NUMERIC(20, 2) DEFAULT NULL, imposable_amount NUMERIC(20, 2) DEFAULT NULL, salary_its NUMERIC(20, 2) DEFAULT NULL, salary_cnps NUMERIC(20, 2) DEFAULT NULL, salary_cmu NUMERIC(20, 2) DEFAULT NULL, fixcal_amount NUMERIC(20, 2) DEFAULT NULL, salary_transport NUMERIC(20, 2) DEFAULT NULL, net_payer NUMERIC(20, 2) DEFAULT NULL, salary_sante NUMERIC(20, 2) DEFAULT NULL, employeur_is NUMERIC(20, 2) DEFAULT NULL, employeur_fdfp NUMERIC(20, 2) DEFAULT NULL, employeur_cmu NUMERIC(20, 2) DEFAULT NULL, employeur_pf NUMERIC(20, 2) DEFAULT NULL, employeur_at NUMERIC(20, 2) DEFAULT NULL, employeur_cnps NUMERIC(20, 2) DEFAULT NULL, employeur_sante NUMERIC(20, 2) DEFAULT NULL, employeur_cr NUMERIC(20, 2) DEFAULT NULL, fixcal_amount_employeur NUMERIC(20, 2) DEFAULT NULL, masse_salary NUMERIC(20, 2) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_499FBCC65D430949 (personal_id), INDEX IDX_499FBCC616227374 (campagne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE personal (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, genre VARCHAR(255) NOT NULL, birthday DATE NOT NULL, lieu_naissance VARCHAR(255) DEFAULT NULL, ref_cnps VARCHAR(255) DEFAULT NULL, piece VARCHAR(255) NOT NULL, ref_piece VARCHAR(255) NOT NULL, address VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, ancienity VARCHAR(255) DEFAULT NULL, conjoint VARCHAR(255) DEFAULT NULL, num_certificat VARCHAR(255) DEFAULT NULL, num_extrait_acte VARCHAR(255) DEFAULT NULL, etat_civil VARCHAR(255) DEFAULT NULL, niveau_formation VARCHAR(255) DEFAULT NULL, mode_paiement VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_F18A6D84BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE primes (id INT AUTO_INCREMENT NOT NULL, intitule VARCHAR(255) NOT NULL, taux NUMERIC(10, 2) NOT NULL, code VARCHAR(255) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE salary (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, avantage_id INT DEFAULT NULL, base_amount NUMERIC(20, 2) NOT NULL, sursalaire NUMERIC(20, 2) NOT NULL, brut_amount NUMERIC(20, 2) NOT NULL, prime_transport NUMERIC(20, 2) DEFAULT NULL, prime_logement NUMERIC(20, 2) DEFAULT NULL, prime_fonction NUMERIC(20, 2) DEFAULT NULL, brut_imposable NUMERIC(20, 2) NOT NULL, smig NUMERIC(20, 2) NOT NULL, total_prime_juridique NUMERIC(20, 2) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_9413BB715D430949 (personal_id), INDEX IDX_9413BB71EA96B22C (avantage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
