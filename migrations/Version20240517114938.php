 ...
 */
final class Version20240517114938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account_bank (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, user_id INT DEFAULT NULL, bank_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, num_compte VARCHAR(255) NOT NULL, rib VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, code_agence VARCHAR(255) NOT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_54F338D05D430949 (personal_id), INDEX IDX_54F338D0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE category_salarie (id INT AUTO_INCREMENT NOT NULL, smigs_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_45567A6449FF82A0 (smigs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE conge (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, user_id INT DEFAULT NULL, date_depart DATE NOT NULL, date_retour DATE NOT NULL, date_reprise DATE NOT NULL, date_dernier_retour DATE DEFAULT NULL, salaire_moyen NUMERIC(20, 2) DEFAULT NULL, allocation_conge NUMERIC(20, 2) DEFAULT NULL, is_conge TINYINT(1) NOT NULL, complete TINYINT(1) NOT NULL, type_conge VARCHAR(255) DEFAULT NULL, type_payement_conge VARCHAR(255) DEFAULT NULL, gratification NUMERIC(20, 2) DEFAULT NULL, allocation_payer NUMERIC(20, 2) DEFAULT NULL, allocation_reste NUMERIC(20, 2) DEFAULT NULL, days NUMERIC(8, 2) DEFAULT NULL, days_plus NUMERIC(8, 2) DEFAULT NULL, salary_due NUMERIC(20, 2) DEFAULT NULL, work_months NUMERIC(8, 2) DEFAULT NULL, total_days NUMERIC(8, 2) DEFAULT NULL, older_days NUMERIC(8, 2) DEFAULT NULL, remaining_vacation NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_2ED893485D430949 (personal_id), INDEX IDX_2ED89348A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE conge_partiel (id INT AUTO_INCREMENT NOT NULL, conge_id INT DEFAULT NULL, date_depart DATE NOT NULL, date_retour DATE NOT NULL, allocation_conge NUMERIC(20, 2) DEFAULT NULL, days NUMERIC(8, 2) DEFAULT NULL, INDEX IDX_1EE74E53CAAC9A59 (conge_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE departure (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, user_id INT DEFAULT NULL, date DATE NOT NULL, is_paied TINYINT(1) DEFAULT NULL, conge_amount NUMERIC(20, 2) DEFAULT NULL, dissmissal_amount NUMERIC(20, 2) DEFAULT NULL, notice_amount NUMERIC(20, 2) DEFAULT NULL, reason VARCHAR(255) NOT NULL, reason_code VARCHAR(255) NOT NULL, salary_due NUMERIC(20, 2) DEFAULT NULL, gratification NUMERIC(20, 2) DEFAULT NULL, frais_funeraire NUMERIC(20, 2) DEFAULT NULL, amount_lcmt_imposable NUMERIC(20, 2) DEFAULT NULL, amount_lcmt_no_imposable NUMERIC(20, 2) DEFAULT NULL, total_indemnite_imposable NUMERIC(20, 2) DEFAULT NULL, day_of_presence NUMERIC(10, 2) DEFAULT NULL, date_retour_conge DATE DEFAULT NULL, cumul_salaire NUMERIC(20, 2) DEFAULT NULL, nb_part NUMERIC(10, 2) DEFAULT NULL, impot_brut NUMERIC(20, 2) DEFAULT NULL, credit_impot NUMERIC(20, 2) DEFAULT NULL, impot_net NUMERIC(20, 2) DEFAULT NULL, amount_cmu NUMERIC(20, 2) DEFAULT NULL, amount_cnps NUMERIC(20, 2) DEFAULT NULL, totat_charge_personal NUMERIC(20, 2) DEFAULT NULL, amount_is NUMERIC(20, 2) DEFAULT NULL, amount_cr NUMERIC(20, 2) DEFAULT NULL, amount_pf NUMERIC(20, 2) DEFAULT NULL, amount_at NUMERIC(20, 2) DEFAULT NULL, amount_ta NUMERIC(20, 2) DEFAULT NULL, amountfpc NUMERIC(20, 2) DEFAULT NULL, amount_fpc_year NUMERIC(20, 2) DEFAULT NULL, amount_cmu_e NUMERIC(20, 2) DEFAULT NULL, total_charge_employer NUMERIC(20, 2) DEFAULT NULL, net_payer NUMERIC(20, 2) DEFAULT NULL, periode_references NUMERIC(10, 2) DEFAULT NULL, conges_ouvrable NUMERIC(10, 2) DEFAULT NULL, global_moyen NUMERIC(20, 2) DEFAULT NULL, gratification_corresp NUMERIC(20, 2) DEFAULT NULL, older_personal NUMERIC(10, 2) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_45E9C6715D430949 (personal_id), INDEX IDX_45E9C671A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE work_time (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, hour_value INT DEFAULT NULL, code VARCHAR(255) DEFAULT NULL, rate_value INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
