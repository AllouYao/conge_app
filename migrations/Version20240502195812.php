 ...
 */
final class Version20240502195812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conge (id INT AUTO_INCREMENT NOT NULL, personal_id INT NOT NULL, user_id INT DEFAULT NULL, date_depart DATE NOT NULL, date_retour DATE NOT NULL, date_reprise DATE NOT NULL, date_dernier_retour DATE DEFAULT NULL, salaire_moyen NUMERIC(20, 2) DEFAULT NULL, allocation_conge NUMERIC(20, 2) DEFAULT NULL, is_conge TINYINT(1) NOT NULL, type_conge VARCHAR(255) DEFAULT NULL, type_payement_conge VARCHAR(255) DEFAULT NULL, gratification NUMERIC(20, 2) DEFAULT NULL, days NUMERIC(8, 2) DEFAULT NULL, days_plus NUMERIC(8, 2) DEFAULT NULL, salary_due NUMERIC(20, 2) DEFAULT NULL, work_months NUMERIC(8, 2) DEFAULT NULL, total_days NUMERIC(8, 2) DEFAULT NULL, older_days NUMERIC(8, 2) DEFAULT NULL, remaining_vacation NUMERIC(10, 2) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_2ED893485D430949 (personal_id), INDEX IDX_2ED89348A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE salary (id INT AUTO_INCREMENT NOT NULL, avantage_id INT DEFAULT NULL, personal_id INT NOT NULL, base_amount NUMERIC(20, 2) NOT NULL, sursalaire NUMERIC(20, 2) NOT NULL, brut_amount NUMERIC(20, 2) NOT NULL, prime_transport NUMERIC(20, 2) DEFAULT NULL, brut_imposable NUMERIC(20, 2) NOT NULL, smig NUMERIC(20, 2) NOT NULL, total_prime_juridique NUMERIC(20, 2) DEFAULT NULL, prime_aciennete NUMERIC(20, 2) DEFAULT NULL, transport_imposable NUMERIC(20, 2) DEFAULT NULL, amount_aventage NUMERIC(20, 2) DEFAULT NULL, total_autre_primes NUMERIC(20, 2) DEFAULT NULL, gratification NUMERIC(20, 2) DEFAULT NULL, uuid VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_9413BB71EA96B22C (avantage_id), UNIQUE INDEX UNIQ_9413BB715D430949 (personal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
