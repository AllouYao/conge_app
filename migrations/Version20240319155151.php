 ...
 */
final class Version20240319155151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE heure_sup ADD status VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE heure_sup DROP status');
        $this->addSql('ALTER TABLE operation ADD campagne_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE operation ADD CONSTRAINT FK_1981A66D16227374 FOREIGN KEY (campagne_id) REFERENCES campagne (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
